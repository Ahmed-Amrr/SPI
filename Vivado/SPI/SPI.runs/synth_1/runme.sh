...
HD_PWD='D:/college/Courses/Kareem Wassem/Projects/SPI/SPI Design/SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_top_module.tcl
